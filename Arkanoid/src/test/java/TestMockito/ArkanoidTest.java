...
class ArkanoidTest {
    ...
    void paint() {
        ...
        //paso el numero de vidas a 0

        spyArkanoid.paint(g);

        verify(g, times(1)).drawString("GAME OVER! LOOSER", 80, 100);
        //compruebo si se llama a drawString....
    }
    ...
    void mouseDown() {
        ...
        spyArkanoid.setPuntuacion(7500); //asigno la puntuacion a 7500
        spyArkanoid.setNumVidas(0); //asigno el numero de vidas a 10
